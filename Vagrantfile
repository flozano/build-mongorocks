...
#    vb.customize ["setextradata", :id, "VBoxInternal/CPUM/SSE4.2","1"]
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    yum -y install gcc gcc-c++ rpmdevtools rpm-build glibc-devel.x86_64 libstdc++-devel.x86_64 boost.x86_64 hg git python-httplib2 snappy-devel zlib-devel bzip2-devel createrepo cyrus-sasl-devel openssl-devel golang
